  ...
  <div>
    ...
    <div class="container">
      <div class="handle-box">
        ...
        <el-input v-model="query.name" placeholder="上级分类名称" class="handle-input mr10"></el-input>
      ...
      >
        <el-table-column prop="id" label="ID" width="55" align="center"></el-table-column>
          ...
          <el-table-column prop="name" label="上级分类名称"></el-table-column>
          ...
          <el-table-column label="操作" width="180" align="center">
            <template slot-scope="scope">
              <router-link :to="{path:'goodsTypeAdd',query:{'id':scope.row.id}}">
                <el-button
